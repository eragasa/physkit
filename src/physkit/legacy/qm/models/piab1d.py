"""Deprecated one-dimensional particle-in-a-box model interfaces.

Use :mod:`physkit.qm.piab1d` for maintained implementations.
"""
...
from physkit.legacy.qm.models.piab import (
    Piab,
    PiabResult,
    PiabSolver,
)
